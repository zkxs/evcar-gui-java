...
{	
	...
	public static final GaugeParameters
		CURRENT_GAGUE_PARAMETERS = new GaugeParameters(0, 100, dp -> dp.getCurrent()),
		VOLTAGE_GAGUE_PARAMETERS = new GaugeParameters(0, 100, dp -> dp.getVoltage()),
		RPM_GAGUE_PARAMETERS     = new GaugeParameters(0, 100, dp -> dp.getRpm());
